                ...
                <ul className="today-datas">
                  ...
                  <li className="bred">
                    ...
                    <div className="pull-left">
                      <span id="todayspark1" className="spark"></span>
                    </div>
                    {/* <!-- Text --> */}
                    <div className="datas-text pull-right">
                      <span className="bold">12,000</span> Visitors/Day
                    </div>
                  ...
                  <li className="bgreen">
                    ...
                    {/* <!-- Text --> */}
                    <div className="datas-text pull-right">
                      <span className="bold">30,000</span> Members
                    </div>
                  ...
                  <li className="blightblue">
                    {/* <!-- Graph --> */}
                    <div className="pull-left">
                      <span id="todayspark2" className="spark"></span>
                    </div>
                    {/* <!-- Text --> */}
                    <div className="datas-text pull-right">
                      <span className="bold">15.66%</span> Bounce Rate
                    </div>
                  ...
                  <li className="bviolet">
                    {/* <!-- Graph --> */}
                    <div className="pull-left">
                      <span id="todayspark3" className="spark"></span>
                    </div>
                    {/* <!-- Text --> */}
                    <div className="datas-text pull-right">
                      <span className="bold">$22,000</span> Total Profit
                    </div>
                    ...
                    <div className="padd">
                      ...
                      <ul className="current-status">
                        <li>
                          ...
                          <span className="bold">Visits : 2000</span>{" "}
                          <i className="fa fa-arrow-up green"></i>
                        </li>
                        <li>
                          <span id="status2"></span>{" "}
                          <span className="bold">Unique Visitors : 1,345</span>{" "}
                          <i className="fa fa-arrow-down red"></i>
                        </li>
                        <li>
                          <span id="status3"></span>{" "}
                          <span className="bold">Pageviews : 2000</span>{" "}
                          <i className="fa fa-arrow-up green"></i>
                        </li>
                        <li>
                          <span id="status4"></span>{" "}
                          <span className="bold">Pages / Visit : 2000</span>{" "}
                          <i className="fa fa-arrow-down red"></i>
                        </li>
                        <li>
                          <span id="status5"></span>{" "}
                          <span className="bold">
                            Avg. Visit Duration : 2000
                          </span>{" "}
                          <i className="fa fa-arrow-down red"></i>
                        </li>
                        <li>
                          <span id="status6"></span>{" "}
                          <span className="bold">Bounce Rate : 2000</span>{" "}
                          <i className="fa fa-arrow-up green"></i>
                        </li>
                        <li>
                          <span id="status7"></span>{" "}
                          <span className="bold">% New Visits : 2000</span>{" "}
                          <i className="fa fa-arrow-up green"></i>
                        </li>
                      </ul>
                    </div>
                      ...
                      <ul className="chats">
                        ...
                        <li className="by-other">
                          ...
                          <div className="chat-content">
                            ...
                            <div className="chat-meta">
                              3 hours ago{" "}
                              <span className="pull-right">Ravi</span>
                            </div>
                  ...
                  <div className="widget-content">
                    ...
                    <ul className="file-upload">
                      <li>
                        {/* <!-- Icon with file name --> */}
                        <strong>
                          <i className="fa fa-upload green"></i>{" "}
                          File_Name_Here.Mp3
                        </strong>
                        {/* <!-- Progress bar --> */}
                      ...
                      <li>
                        <strong>
                          <i className="fa fa-ok red"></i> Second_File.Mp3
                        </strong>
                        <div className="file-meta">
                          5MB - 5 mins - Completed
                        </div>
                      </li>

                      <li>
                        <strong>
                          <i className="fa fa-ok red"></i> Third_File_Here.Mp3
                        </strong>
                ...
                <div className="widget worange">
                  ...
                  <div className="widget-content referrer">
                    ...
                    <table className="table  table-bordered ">
                      ...
                      <tr>
                        <td>
                          <img src="img/icons/chrome.png" alt="" />
                        </td>
                        <td>Google Chrome</td>
                        <td>3,005</td>
                      </tr>
                      <tr>
                        <td>
                          <img src="img/icons/firefox.png" alt="" />
                        </td>
                      ...
                      <tr>
                        <td>
                          <img src="img/icons/opera.png" alt="" />
                        </td>
                        <td>Opera</td>
                        <td>4,005</td>
                      </tr>
                      <tr>
                        <td>
                          <img src="img/icons/safari.png" alt="" />
                        </td>
                        <td>Safari</td>
                        <td>505</td>
                      </tr>
                ...
                <div className="widget wblue">
                  ...
                  <div className="widget-content">
                    <div className="padd">
                      ...
                      {/* <!-- Hover location --> */}
                      <div id="hoverdata">
                        Mouse hovers at (<span id="x">0</span>,{" "}
